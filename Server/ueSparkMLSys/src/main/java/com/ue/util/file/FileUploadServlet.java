...
public class FileUploadServlet extends HttpServlet {
	...
	/**
	 * save file uploadPrograrm to server
...
//		ServletFileUpload uploadPrograrm = new ServletFileUpload(factory);
//		uploadPrograrm.setHeaderEncoding("UTF-8");
//		List items = null;
//		List items_findId = null;
//		try {
//			items = uploadPrograrm.parseRequest(request);
//			items_findId = items;
